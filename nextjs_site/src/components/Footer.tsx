  ...
  return (
    <footer className="bg-surface-container-low pt-16 pb-12 mt-4 relative z-10 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-8 relative">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-12 w-full">
          ...
          <div className="flex flex-col items-start gap-4 max-w-sm">
            <div className="flex items-center gap-3">
              ...
              />
              <h2 className="font-headline text-3xl font-black text-on-surface leading-none">
          ...
          <div className="flex flex-col items-start gap-6 min-w-[140px]">
            <h3 className="font-headline text-base font-bold text-on-surface uppercase tracking-widest">Sitemap</h3>
            <ul className="flex flex-col gap-3">
              {sitemapLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.path}
                    className="group flex items-center gap-2 font-body text-sm text-on-surface-variant hover:text-on-surface transition-colors"
                  >
          ...
          <div className="flex flex-col items-start gap-6">
            <h3 className="font-headline text-base font-bold text-on-surface uppercase tracking-widest">Visit Us</h3>
            
            <div className="flex flex-col gap-6">
              {/* Address */}
              <div className="group flex items-start gap-4 cursor-pointer">
                <div className="flex-shrink-0 w-10 h-10 rounded-xl dark:bg-white/5 bg-black/5 border dark:border-white/10 border-black/10 flex items-center justify-center transition-all duration-300 group-hover:bg-primary/20 group-hover:border-primary/40 group-hover:scale-110 shadow-[0_0_0_rgba(37,99,235,0)] group-hover:shadow-[0_0_15px_rgba(37,99,235,0.4)]">
                  <MapPin className="w-5 h-5 text-blue-300 transition-colors duration-300 group-hover:text-primary" />
                </div>
                <div className="flex flex-col gap-1">
                  <h4 className="font-headline text-sm font-bold text-on-surface transition-colors duration-300 group-hover:text-primary">Address</h4>
                  <p className="font-body text-sm text-on-surface-variant leading-relaxed whitespace-nowrap transition-colors duration-300 group-hover:text-on-surface">
              ...
              <div className="group flex items-start gap-4 cursor-pointer">
                ...
                <div className="flex flex-col gap-1">
                  <h4 className="font-headline text-sm font-bold text-on-surface transition-colors duration-300 group-hover:text-primary">Phone</h4>
                  <p className="font-body text-sm text-on-surface-variant leading-relaxed transition-colors duration-300 group-hover:text-on-surface">
                    +91 70870 32853
                  </p>
                </div>
              </div>
        ...
        {/* Divider & Copyright */}
        <div className="w-full h-px dark:bg-white/10 bg-black/10 mb-6"></div>
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <button 
            onClick={scrollToTop}
            className="group flex items-center gap-2 px-4 py-2 rounded-full dark:bg-white/5 bg-black/5 border dark:border-white/10 border-black/10 text-on-surface-variant text-sm font-bold uppercase tracking-widest hover:bg-primary/20 hover:text-on-surface hover:border-primary/50 transition-all duration-300 shadow-md hover:shadow-[0_0_15px_rgba(37,99,235,0.3)]"
          >
