...
// Shared data
const stats = [
  { icon: "science", count: 31, label: "Established CPS Labs", suffix: "" },
...
const workshops = [
  ...
  },
  {
    ...
    description:
      "A two-day CPS Workshop at Chitkara University, engaging 19 students in hands-on learning and innovation.",
  ...
  },
  {
    ...
    description:
      "Two-day hands-on workshop training students on BLE Development Kits and 3D printing.",
