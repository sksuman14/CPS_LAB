              ...
              {authStep === 'LOGIN_SIGNUP' && (
                <>
                  ...
                  <div className="mt-8 flex flex-col items-center gap-4">
                    <button
                      onClick={toggleMode}
                      className="font-body text-on-surface-variant hover:text-white transition-colors text-xs mb-2"
                    >
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-3 font-semibold text-sm py-4 rounded-2xl shadow-lg active:scale-[0.98]"
                    >
                      <GoogleIcon />
                ...
                <>
                  ...
                  <form onSubmit={handleForgotPasswordRequest} className="flex flex-col gap-5">
                    ...
                    <button
                      type="button"
                      onClick={() => setAuthStep('LOGIN_SIGNUP')}
                      className="text-white/60 text-xs mt-2 flex items-center justify-center gap-2"
                    >
                      <span className="material-symbols-outlined text-sm">arrow_back</span> Back to Sign In
                    </button>
                  </form>
              ...
              {authStep === 'CONFIRM_FORGOT_PASSWORD' && (
                <>
                  ...
                  <form onSubmit={handlePasswordReset} className="flex flex-col gap-5">
                    ...
                    <button type="submit" className="w-full bg-primary hover:bg-primary-light text-white font-headline font-bold text-base py-4 rounded-2xl">
                      Update Password
                    </button>
                  </form>
                </>
