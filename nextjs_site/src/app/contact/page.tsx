        ...
        <motion.div variants={containerVariants} initial="hidden" animate="show" className="mb-12">
          ...
          <motion.div variants={itemVariants} className="bg-surface-container border border-white/5 p-6 md:p-8 rounded-2xl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                <strong className="block mb-1 font-headline not-italic text-white text-base">IIT Ropar – Technology & Innovation Foundation <span className="text-primary">(iHub-AWaDH)</span></strong>
              </div>
