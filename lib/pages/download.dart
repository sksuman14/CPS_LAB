...
class DownloadManager {
  static final Map<String, Map<String, String>> sensorFiles = {
    ...
    "BLENODE": {"datasheet": "assets/pdfs/BLENODE.pdf", "manual": ""},
    "FLASHTOOL": {"datasheet": "assets/pdfs/FLASHTOOL.pdf", "manual": ""},
    "LUX": {
      "datasheet": "assets/pdfs/LUX.pdf",
      "manual": "assets/pdfs/Lux_manual.pdf",
    },
    "HALL": {"datasheet": "assets/pdfs/HALL.pdf", "manual": "assets/pdfs/Hall_manual.pdf"},
    "IR": {"datasheet": "assets/pdfs/IR.pdf", "manual": ""},
    "TLV": {
    ...
    "GROOVE": {"datasheet": "assets/pdfs/GROOVE.pdf", "manual": ""},
    "Gateway": {
